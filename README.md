...
replacing `cu.usbmodemfa141` with the name of the appropriate serial port.  NOTE: on Linux/OS X, you don't need to give the full path of the port (e.g. `/dev/cu.usbmodemfa141`) only the file name.
